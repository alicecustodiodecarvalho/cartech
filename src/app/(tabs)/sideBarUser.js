...
import fots from '../../../assets/images/nophoto.jpg';
...
export default function SideBarUser() {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.textContainer} onPress={() => router.push('/atualizarDadosUser')}>
                <Text style={styles.Text}>Atualizar Dados da Conta</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.textContainer} onPress={() => router.push('/minhasCompras')}>
                <Text style={styles.Text}>Minhas Compras</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.textContainer} onPress={() => router.push('/sobreNos')}>
                <Text style={styles.Text}>Sobre nós</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.textContainer} onPress={() => router.push('/regras')}>
