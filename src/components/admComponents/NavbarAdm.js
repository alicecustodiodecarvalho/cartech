    ...
    return (
        <View style={styles.navbarContainer}>
            <View style={styles.titleContainer}>
                ...
                <View style={styles.user}>
                    ...
                    <TouchableOpacity onPress={handleImagePicker}>
                        <Image
                            source={foto_perfil ? { uri: foto_perfil } : avatar} 
                            style={styles.avatar}
                        />
                    </TouchableOpacity>
                </View>
            ...
            <View style={styles.navbar}>
                <TouchableOpacity style={[styles.navItem]} onPress={() => router.push('/admPages/detalhesUser')}>
                    {user === true ?
                        <Text style={styles.navTextAct}>Usuários</Text>
                        : <Text style={styles.navText}>Usuários</Text>}
                </TouchableOpacity>

                <TouchableOpacity style={[styles.navItem]} onPress={() => router.push('/admPages/administradores')}>
                    {vend === true ?
